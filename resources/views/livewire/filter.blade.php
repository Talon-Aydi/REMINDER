<div class="w-screen h-screen flex flex-col justify-center">
        <div class="flex flex-col w-[20rem] h-[25rem] justify-center text-center text-white m-auto space-y-2">
            <span class="text-[2rem] font-bold">Filter component</span>
            <input 
                wire:model.live.debounce.250ms="namefield"
                type="text" 
                name="name" 
                id="name" 
                class="w-full h-[3rem] text-black bg-white px-3 border-0 rounded-sm" 
